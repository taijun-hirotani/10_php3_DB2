...
function GetMap() {
    ...
    for (let i = 0; i < len; i++){
      options[i] = {
        ...
        //"actions": "<div><a href='"+json[i].url+"'>LINK</a><br><img src="" width="300"></div>",
...
for(let i=0; i<hirotani/*回数を自動取得*/; i++){
    ...
    taijun+=`<a href="select_owner1.php? id="json[i].id"><p>${json[i].title+' '+json[i].address+' '+json[i].img}</a></p>`;
